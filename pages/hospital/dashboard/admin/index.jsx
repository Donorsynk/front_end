  ...
  return (
    <main className="flex-col items-center justify-between min-h-screen ">
      ...
      <div className="flex gap-4 mx-10">
        <div className="w-4/5 p-5 bg-white rounded-lg ">
        ...
        <div className="p-5 bg-white rounded-lg flex-1/3">
          ...
          <div className="flex gap-3 my-5 align-center">
            <div>
              <Image
            ...
            <div className="flex flex-col items-start">
              <div className="flex gap-3 space-between align-center">
                <p>ETH Hacker</p>
