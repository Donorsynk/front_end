...
const validationSchema = Yup.object().shape({
  ...
  const handleSubmit = async (values) => {
    ...
    const response = await fetch(values.logo);
    ...
    formData.append("hospitalDesc", values.hospitalDesc);
    formData.append("logo", values.logo);
    formData.append("hospitalLocation", values.hospitalLocation);
    formData.append("hospitalmot", values.hospitalmot);
    formData.append("stateCountry", values.stateCountry);
    formData.append("businessRegistration", values.businessRegistration);
